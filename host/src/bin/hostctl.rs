...
#[derive(Parser)]
#[command(
    about = "起動済みhostの観測・設定・操作。action: status/config/claim/heartbeat/release/run/stop/estop/cut/safe/origin/adjustment/input/apply/save/connection/reinit/fault"
)]
struct Args {
    action: String,
    #[arg(long)]
